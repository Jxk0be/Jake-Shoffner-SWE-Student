...
const Navbar = () => {
  ...
  return (
    <div className={`hidden items-center text-black text-lg font-bold fixed z-30 drop-shadow-xl bg-[#0b0e10]/90 duration-300 h-screen lg:flex justify-center md:w-[170px] ${sidebar ? 'ml-[-120px]' : ''}`}>
