    ...
    <>
      <div className={`hidden items-center text-[#b3b3b3] text-[17px] font-bold fixed z-50 drop-shadow-xl bg-[#121212] duration-300 h-screen lg:flex justify-center md:w-[170px] ${sidebar ? 'ml-[-120px]' : ''}`}>
        ...
        <div className={`mr-[40px] z-10 flex noSelect justify-between flex-col h-[300px] ${sidebar ? 'opacity-0' : ''}`}>
          ...
          <Link to="/home">
            <div onClick={() => setSidebar(!sidebar)} className='flex group justify-between w-[160px] bg-[#212121] hover:bg-white py-2 hover:text-[#212121] rounded-xl pr-2 pl-5 hover:scale-105 cursor-pointer duration-300'>
        ...
        {sidebar ? 
        <div onClick={() => setSidebar(!sidebar)} className='bg-[#212121] hover:bg-white hover:text-[#212121] font-semibold ml-[-79px] px-1.5 py-1 rounded-xl z-40 cursor-pointer select-none duration-150 items-center flex flex-col text-xl group'>
