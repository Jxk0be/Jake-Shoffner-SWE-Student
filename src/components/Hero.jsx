  ...
  return (
    <div className='w-full pt-[70px] h-screen md:pt-[0vh] flex justify-between items-center flex-col text-[#F5EFED]'>
      <div className='grid md:grid-rows-1 h-screen max-w-[1500px] grid-flow-col w-full grid-rows-2 m-[5vh] gap-x-10 gap-y-4 p-5'>
        ...
        <div className='flex flex-col w-full min-w-[600px] justify-center'>
            <h1 className='text-4xl grad font-[400] text-[] drop-shadow-lg'>Hello, I'm</h1>
            <h1 className='capitalize font-[700] text-6xl drop-shadow-lg'>Jake Shoffner</h1>
            <Typed className="text-[#59A5D8] text-4xl font-[500]" strings={['Software engineer...', 'Problem solver...', 'Self-proclaimed comedian...']} typeSpeed={65} loop backDelay={1800} backSpeed={50}/>
        </div>  

        <div className='flex items-center w-full text-xl text-[#d8dad9] justify-center'>
